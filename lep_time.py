...
def get_now_acc_msec()->int: return round(Time.time()*1000)

# 秒级时间戳, acc=Accuracy=精度, 如: c
def get_now_acc_sec()->int: return round(Time.time())

# 得到当前时间戳, 如: 1657083246.6974413
def get_now_origin()->float:  return Time.time()
...
def get_now_struct()->Time.struct_time: return Time.localtime()

# 得到时间字符串, 如: Wed Jul  6 12:57:56 2022
def get_now_asc()->str: return Time.asctime( Time.localtime() )
